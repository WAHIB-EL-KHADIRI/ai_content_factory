...
from .utils import retry_with_backoff, generate_cache_key, get_cached_file, file_exists_and_valid
...
class VoiceoverGenerator:
    ...
    def _generate_azure(self, text: str, output_path: str):
        ...
        try:
            ...
            speech_config.speech_synthesis_voice_name = config.get('voice_name', 'en-US-JennyNeural')
