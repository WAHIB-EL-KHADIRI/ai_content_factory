...
class VisualGenerator:
    ...
    def generate_image(
        self, prompt: str, output_path: Optional[str] = None, mock: bool = False
    ) -> str:
        """
    ...
    def _generate_local(self, prompt: str, output_path: str):
        ...
        try:
            ...
            image = pipe(
                prompt=prompt, num_inference_steps=num_steps, height=1024, width=1792
            ).images[0]
            ...
            logger.error(
                "Diffusers/Torch not installed. Install with: pip install diffusers torch"
            )
            raise
